...
additionalProperties:
  packageGuid: '{5EF2F9AC-9FA3-437D-9AC6-F411403CBCAD}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAmsHistoryApi>();
            IDeleteOldHistoryApiV1AmsHistoryPrinterIdDeleteApiResponse apiResponse = await api.DeleteOldHistoryApiV1AmsHistoryPrinterIdDeleteAsync("todo");
...
- appName: Bambuddy
- appVersion: 0.2.4.5
- appDescription: Archive and manage Bambu Lab 3MF files
