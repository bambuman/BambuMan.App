...
namespace SpoolMan.Api.Test.Api
{
    ...
    {
        private readonly ISettingApi instance;

        public SettingApiTests() : base(Array.Empty<string>())
        {
            instance = host.Services.GetRequiredService<ISettingApi>();
        }
        ...
        {
            var response = await instance.GetAllSettingsSettingGetAsync();
        ...
        {
            string key = default!;
            var response = await instance.GetSettingSettingKeyGetAsync(key);
            var model = response.Ok();
        ...
        public async Task SetSettingSettingKeyPostAsyncTest()
        {
            string key = default!;
            string body = default!;
            var response = await instance.SetSettingSettingKeyPostAsync(key, body);
            var model = response.Ok();
            Assert.IsType<SettingResponse>(model);
        }
    }
